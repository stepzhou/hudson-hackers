...
Foursquare.prototype.makeRequest = function(query, callback) {
  var query = query + ((query.indexOf('?') > -1) ? '&' : '?') + "&client_id=PF4Q2R5DJRQDBH1KLXPAUJAX0200NRT0S3IHDNDADDGHCRYB&client_secret=BFPSDMC5R2RSUCMQQSO0KESAJ2P12FBP4GNZAV1BV3PPDDUM&v=20131126"
  ;
